function Operator({
  ...
  const handleOperClick = () => {
    const operFunc =
      operator === "" ? setOperator((prev) => (prev = func)) : operator;
  ...
  return (
    <input
      className={`btn btn-operator ${className}`}
      type="button"
      value={value}
      onClick={handleOperClick}
    />
  );
}
...
function Operand({ value, onClick, className }) {
  return (
    <input
      className={`btn btn-operand ${className}`}
      type="button"
      value={value}
      onClick={onClick}
    />
...
// function ResultOperations({ value, className }) {
//   return (
//     <input
//       className={`btn ${className}`}
//       type="button"
